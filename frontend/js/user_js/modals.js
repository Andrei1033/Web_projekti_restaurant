...
document.addEventListener('DOMContentLoaded', () => {
      ...
      // pay modal
      document.getElementById('osb-checkout-btn')?.addEventListener('click', () => openModal('checkout-modal'));
      ...
      if (profileForm) {
         profileForm.addEventListener('submit', (e) => {
            ...
            const password = profileForm.querySelector('#profile-password')?.value || '';
            const avatarSrc = avatarPreview?.src || '';
            saveProfile({ name, email, phone, password: password ? 'set' : '', avatar: avatarSrc });
      ...
      document.getElementById('profile_button')?.addEventListener('click', loadProfile);
